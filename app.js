...
/**
	...
	@protected
	@param {Array} reviews Array of product reviews to calculate the average with
...
module.exports = {
	/**
		...
		@param {Array} skus Array of SKUs, one for each product to fetch
	...
	*/
	fetchProductReviews: (skus, {outputDir, apiKey}) => {
